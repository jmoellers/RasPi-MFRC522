...
int MFRC522_Auth(unsigned char authMode, int BlockAddr, unsigned char *Sectorkey, size_t SectorkeyLen, unsigned char *serNum);
void MFRC522_Read(unsigned char blockAddr);
void MFRC522_Write(unsigned char blockAddr, unsigned char *writeData, size_t writeDataLen);
